...
type Server struct {
	...
	ServerProvider ServerProvider `json:"serverProvider"`
...
func (ServerProvider) IsNode() {}

// The id of the object.
func (this ServerProvider) GetID() gidx.PrefixedID { return this.ID }

func (ServerProvider) IsEntity() {}
...
type ServerProviderEdge struct {
	// The item at the end of the edge.
	Node *ServerProvider `json:"node,omitempty"`
	// A cursor for use in pagination.
	Cursor string `json:"cursor"`
}
...
func (e ServerOrderField) IsValid() bool {
	switch e {
	case ServerOrderFieldID, ServerOrderFieldCreatedAt, ServerOrderFieldUpdatedAt, ServerOrderFieldName, ServerOrderFieldDescription, ServerOrderFieldOwner:
		return true
	}
	return false
}
