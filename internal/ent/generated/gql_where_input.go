...
// ServerAttributeWhereInput represents a where input for filtering ServerAttribute queries.
type ServerAttributeWhereInput struct {
	Predicates []predicate.ServerAttribute  `json:"-"`
...
// AddPredicates adds custom predicates to the where input to be used during the filtering phase.
func (i *ServerAttributeWhereInput) AddPredicates(predicates ...predicate.ServerAttribute) {
	i.Predicates = append(i.Predicates, predicates...)
}

// Filter applies the ServerAttributeWhereInput filter on the ServerAttributeQuery builder.
func (i *ServerAttributeWhereInput) Filter(q *ServerAttributeQuery) (*ServerAttributeQuery, error) {
	if i == nil {
		return q, nil
	}
	p, err := i.P()
	if err != nil {
		if err == ErrEmptyServerAttributeWhereInput {
			return q, nil
		}
		return nil, err
	}
...
// ErrEmptyServerAttributeWhereInput is returned in case the ServerAttributeWhereInput is empty.
var ErrEmptyServerAttributeWhereInput = errors.New("generated: empty predicate ServerAttributeWhereInput")

// P returns a predicate for filtering serverattributes.
// An error is returned if the input is empty or invalid.
func (i *ServerAttributeWhereInput) P() (predicate.ServerAttribute, error) {
	var predicates []predicate.ServerAttribute
	if i.Not != nil {
		p, err := i.Not.P()
		if err != nil {
			return nil, fmt.Errorf("%w: field 'not'", err)
		}
		predicates = append(predicates, serverattribute.Not(p))
	}
	switch n := len(i.Or); {
	case n == 1:
		p, err := i.Or[0].P()
		...
		predicates = append(predicates, p)
	case n > 1:
		or := make([]predicate.ServerAttribute, 0, n)
		for _, w := range i.Or {
			p, err := w.P()
			if err != nil {
				return nil, fmt.Errorf("%w: field 'or'", err)
		...
		predicates = append(predicates, serverattribute.Or(or...))
	}
	switch n := len(i.And); {
	case n == 1:
		p, err := i.And[0].P()
		...
		predicates = append(predicates, p)
	case n > 1:
		and := make([]predicate.ServerAttribute, 0, n)
		for _, w := range i.And {
			p, err := w.P()
			if err != nil {
				return nil, fmt.Errorf("%w: field 'and'", err)
		...
		predicates = append(predicates, serverattribute.And(and...))
	}
	predicates = append(predicates, i.Predicates...)
	if i.ID != nil {
		predicates = append(predicates, serverattribute.IDEQ(*i.ID))
	}
	if i.IDNEQ != nil {
		predicates = append(predicates, serverattribute.IDNEQ(*i.IDNEQ))
	}
	if len(i.IDIn) > 0 {
		predicates = append(predicates, serverattribute.IDIn(i.IDIn...))
	}
	if len(i.IDNotIn) > 0 {
		predicates = append(predicates, serverattribute.IDNotIn(i.IDNotIn...))
	}
	if i.IDGT != nil {
		predicates = append(predicates, serverattribute.IDGT(*i.IDGT))
	}
	if i.IDGTE != nil {
		predicates = append(predicates, serverattribute.IDGTE(*i.IDGTE))
	}
	if i.IDLT != nil {
		predicates = append(predicates, serverattribute.IDLT(*i.IDLT))
	}
	if i.IDLTE != nil {
		predicates = append(predicates, serverattribute.IDLTE(*i.IDLTE))
	}
	if i.CreatedAt != nil {
		predicates = append(predicates, serverattribute.CreatedAtEQ(*i.CreatedAt))
	}
	if i.CreatedAtNEQ != nil {
		predicates = append(predicates, serverattribute.CreatedAtNEQ(*i.CreatedAtNEQ))
	}
	if len(i.CreatedAtIn) > 0 {
		predicates = append(predicates, serverattribute.CreatedAtIn(i.CreatedAtIn...))
	}
	if len(i.CreatedAtNotIn) > 0 {
		predicates = append(predicates, serverattribute.CreatedAtNotIn(i.CreatedAtNotIn...))
	}
	if i.CreatedAtGT != nil {
		predicates = append(predicates, serverattribute.CreatedAtGT(*i.CreatedAtGT))
	}
	if i.CreatedAtGTE != nil {
		predicates = append(predicates, serverattribute.CreatedAtGTE(*i.CreatedAtGTE))
	}
	if i.CreatedAtLT != nil {
		predicates = append(predicates, serverattribute.CreatedAtLT(*i.CreatedAtLT))
	}
	if i.CreatedAtLTE != nil {
		predicates = append(predicates, serverattribute.CreatedAtLTE(*i.CreatedAtLTE))
	}
	if i.UpdatedAt != nil {
		predicates = append(predicates, serverattribute.UpdatedAtEQ(*i.UpdatedAt))
	}
	if i.UpdatedAtNEQ != nil {
		predicates = append(predicates, serverattribute.UpdatedAtNEQ(*i.UpdatedAtNEQ))
	}
	if len(i.UpdatedAtIn) > 0 {
		predicates = append(predicates, serverattribute.UpdatedAtIn(i.UpdatedAtIn...))
	}
	if len(i.UpdatedAtNotIn) > 0 {
		predicates = append(predicates, serverattribute.UpdatedAtNotIn(i.UpdatedAtNotIn...))
	}
	if i.UpdatedAtGT != nil {
		predicates = append(predicates, serverattribute.UpdatedAtGT(*i.UpdatedAtGT))
	}
	if i.UpdatedAtGTE != nil {
		predicates = append(predicates, serverattribute.UpdatedAtGTE(*i.UpdatedAtGTE))
	}
	if i.UpdatedAtLT != nil {
		predicates = append(predicates, serverattribute.UpdatedAtLT(*i.UpdatedAtLT))
	}
	if i.UpdatedAtLTE != nil {
		predicates = append(predicates, serverattribute.UpdatedAtLTE(*i.UpdatedAtLTE))
	}
	if i.Name != nil {
		predicates = append(predicates, serverattribute.NameEQ(*i.Name))
	}
	if i.NameNEQ != nil {
		predicates = append(predicates, serverattribute.NameNEQ(*i.NameNEQ))
	}
	if len(i.NameIn) > 0 {
		predicates = append(predicates, serverattribute.NameIn(i.NameIn...))
	}
	if len(i.NameNotIn) > 0 {
		predicates = append(predicates, serverattribute.NameNotIn(i.NameNotIn...))
	}
	if i.NameGT != nil {
		predicates = append(predicates, serverattribute.NameGT(*i.NameGT))
	}
	if i.NameGTE != nil {
		predicates = append(predicates, serverattribute.NameGTE(*i.NameGTE))
	}
	if i.NameLT != nil {
		predicates = append(predicates, serverattribute.NameLT(*i.NameLT))
	}
	if i.NameLTE != nil {
		predicates = append(predicates, serverattribute.NameLTE(*i.NameLTE))
	}
	if i.NameContains != nil {
		predicates = append(predicates, serverattribute.NameContains(*i.NameContains))
	}
	if i.NameHasPrefix != nil {
		predicates = append(predicates, serverattribute.NameHasPrefix(*i.NameHasPrefix))
	}
	if i.NameHasSuffix != nil {
		predicates = append(predicates, serverattribute.NameHasSuffix(*i.NameHasSuffix))
	}
	if i.NameEqualFold != nil {
		predicates = append(predicates, serverattribute.NameEqualFold(*i.NameEqualFold))
	}
	if i.NameContainsFold != nil {
	...
	case 1:
		return predicates[0], nil
	default:
		return serverattribute.And(predicates...), nil
	}
}
