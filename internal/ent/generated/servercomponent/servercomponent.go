...
const (
	// Label holds the string label denoting the servercomponent type in the database.
	Label = "server_component"
	...
	// FieldComponentTypeID holds the string denoting the component_type_id field in the database.
	FieldComponentTypeID = "component_type_id"
	// EdgeComponentType holds the string denoting the component_type edge name in mutations.
	EdgeComponentType = "component_type"
	// EdgeServer holds the string denoting the server edge name in mutations.
	EdgeServer = "server"
	// Table holds the table name of the servercomponent in the database.
	Table = "server_components"
	// ComponentTypeTable is the table that holds the component_type relation/edge.
	ComponentTypeTable = "server_components"
	// ComponentTypeInverseTable is the table name for the ServerComponentType entity.
	// It exists in this package in order to avoid circular dependency with the "servercomponenttype" package.
	ComponentTypeInverseTable = "server_component_types"
	// ComponentTypeColumn is the table column denoting the component_type relation/edge.
	ComponentTypeColumn = "component_type_id"
	// ServerTable is the table that holds the server relation/edge.
	ServerTable = "server_components"
...
// Columns holds all SQL columns for servercomponent fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
var (
	...
	// ComponentTypeIDValidator is a validator for the "component_type_id" field. It is called by the builders before save.
	ComponentTypeIDValidator func(string) error
	// DefaultID holds the default value on creation for the "id" field.
	DefaultID func() gidx.PrefixedID
)

// OrderOption defines the ordering options for the ServerComponent queries.
...
// ByComponentTypeID orders the results by the component_type_id field.
func ByComponentTypeID(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldComponentTypeID, opts...).ToFunc()
}

// ByComponentTypeField orders the results by component_type field.
func ByComponentTypeField(field string, opts ...sql.OrderTermOption) OrderOption {
	return func(s *sql.Selector) {
		sqlgraph.OrderByNeighborTerms(s, newComponentTypeStep(), sql.OrderByField(field, opts...))
	}
}
...
func newComponentTypeStep() *sqlgraph.Step {
	return sqlgraph.NewStep(
		sqlgraph.From(Table, FieldID),
		sqlgraph.To(ComponentTypeInverseTable, FieldID),
