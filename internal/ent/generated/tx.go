...
func (tx *Tx) init() {
	...
	tx.ServerHardDrive = NewServerHardDriveClient(tx.config)
	tx.ServerHardDriveType = NewServerHardDriveTypeClient(tx.config)
...
// applies a query, for example: Provider.QueryXXX(), the query will be executed
