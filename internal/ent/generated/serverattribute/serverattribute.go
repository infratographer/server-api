...
const (
	// Label holds the string label denoting the serverattribute type in the database.
	Label = "server_attribute"
...
// OrderOption defines the ordering options for the ServerAttribute queries.
